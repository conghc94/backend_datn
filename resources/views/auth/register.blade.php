...
<div class="register-box">
    ...
    <div class="register-box-body">
        <p class="login-box-msg font-bold" >ĐĂNG KÝ TÀI KHOẢN</p>
            ...
            <div class="row">
                <div class="col-xs-8">
                    <div class="checkbox icheck">
                        <label>
                            <input type="checkbox"> Chọn đăng ký là bạn đã đồng ý với các điều khoản trong<a href="#">Thỏa thuận sử dụng </a>
                        </label>
                    </div>
                </div>
                <!-- /.col -->
        ...
        <a href="{{ url('/login') }}" class="text-center">Đã có tài khoản đăng nhập</a>
    </div>
    <!-- /.form-box -->
</div>
<!-- /.register-box -->
